...
I specialize in designing **real-world systems** — handling data flow, execution logic, and automation with reliability and performance in mind.
...
* Work on **event-driven architectures & data pipelines**
...
Transformer-based NLP system (BERT) for analyzing real-world user sentiment.
